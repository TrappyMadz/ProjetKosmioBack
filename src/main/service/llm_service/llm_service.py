...
import constant.llm_constant as llm_constant
...
class LlmService():
    ...
    def mistral_request(self, prompt, content, obj):
        ...
        payload = {
            ...
            "temperature": llm_constant.LLM_TEMPERATURE,
            "response_format": {
                "type": "json_schema",
                "json_schema": {
    ...
    def mistral_request_solution(self,content_metadata_summary, content_first_part, content_last_part):
        ...
        prompt_title_metadata_summary = llm_constant.PROMPT_SOLUTION_TITLE_METADATA_SUMMARY
        ## Attention les deux resultats de ces prompt son à integrer dans content
        prompt_content_firstpart = llm_constant.PROMPT_SOLUTION_CONTENT_FIRSTPART
        prompt_content_lastpart = llm_constant.PROMPT_SOLUTION_CONTENT_LASTPART
